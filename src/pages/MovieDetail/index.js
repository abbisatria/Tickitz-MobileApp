        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.row}>
            <View style={styles.cardMovie}>
              <Image
                source={{
                  uri: `${API_URL}uploads/movies/${this.props.movie.detailMovie.image}`,
                }}
                style={styles.imageMovie}
              />
            </View>
            <Text style={styles.title}>
              {this.props.movie.detailMovie.name}
            </Text>
            <Text style={styles.subTitle}>
              {this.props.movie.detailMovie.genre}
            </Text>
          </View>
          <View>
            <View style={styles.rowDetail}>
              <View style={styles.colRight}>
                ...
                <Text style={styles.name}>
                  {moment(this.props.movie.detailMovie.releaseDate).format(
                    'MMMM D, YYYY',
                  )}
                </Text>
              </View>
              <View style={styles.colLeft}>
                ...
                <Text style={styles.name}>
                  {this.props.movie.detailMovie.directed}
                </Text>
              </View>
            </View>
            <View style={styles.rowDetail}>
              <View style={styles.colRight}>
                ...
                <Text style={styles.name}>
                  {this.props.movie.detailMovie.duration}
                </Text>
              </View>
              <View style={styles.colLeft}>
                <Text style={styles.text}>Casts</Text>
                <Text style={styles.name}>
                  {this.props.movie.detailMovie.casts}
                </Text>
              </View>
            </View>
            ...
            <View>
              ...
              <Text style={styles.descText}>
                {this.props.movie.detailMovie.description}
              </Text>
            </View>
          </View>
          <View style={styles.showtime}>
            ...
            <Select
              icon={<Calendar />}
              data={
                this.props.showtime.showtime && this.props.showtime.showtime
              }
              label="Set a date"
          ...
          {this.props.showtime.errorMsg !== '' ? (
            <Text>{this.props.showtime.errorMsg}</Text>
          ) : this.state.loading ? (
